...
describe("Handle Headers", () => {
    ...
    testHandleHeaders(
        ...
        [
            ...
            [
                "Content-Disposition",
                'attachment;filename="te;t.pdf";filename=img.jpg',
            ],
        ],
        [
            ["Content-Type", "application/pdf"],
            [
                "Content-Disposition",
                'inline;filename="te;t.pdf";filename=img.jpg',
            ],
        ]
    );
    ...
    testHandleHeaders(
        ...
        [
            [
                "Content-Disposition",
                "attachment; filename=\"ABC_2019.pdf\"; filename*=UTF-8''ABC_2019.pdf",
            ],
        ...
        [
            [
                "Content-Disposition",
                "inline; filename=\"ABC_2019.pdf\"; filename*=UTF-8''ABC_2019.pdf",
            ],
            ["Content-Type", "application/pdf"],
        ]
    );
